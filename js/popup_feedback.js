const footerFeedbackButton = document.querySelector(".footer__feedback-button")
...
const showPopupFeedback = () => {
    ...
    popupFeedbackContainer.classList.add("popup__container_shown")
}
const hidePopupFeedback = () => {
    popupFeedback.classList.remove("popup_shown")
    popupFeedbackContainer.classList.remove("popup__container_shown")
}
const togglePopupFeedback = () => {
    popupFeedback.classList.toggle("popup_shown")
    popupFeedbackContainer.classList.toggle("popup__container_shown")
}
